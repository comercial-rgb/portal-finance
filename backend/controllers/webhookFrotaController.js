...
exports.receberOSFrota = async (req, res) => {
  try {
    ...
    const ordemServico = new OrdemServico({
      ...
      descontoPecasPerc: descontoPecasPerc !== undefined ? descontoPecasPerc : (descontoPercentual || 0),
      descontoServicoPerc: descontoServicoPerc !== undefined ? descontoServicoPerc : (descontoPercentual || 0),
